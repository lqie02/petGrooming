...
<?php else: ?>
  ...
  <h3><center>Monthly Sales Package Top 5 (<?php echo date('F Y', strtotime($selectedYear . '-' . $selectedMonth . '-01')); ?>)</center></h3>
  ...
  <table class="table table-hover text-center table-bordered">
    ...
    <tr>
      ...
      <tr>
        ...
        <td><strong>RM <?php echo $totalCharge - $totalSales; ?></strong></td>
      </tr>
    </tbody>
  </table>
</div>
