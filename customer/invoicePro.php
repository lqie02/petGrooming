...
<div class="container-fluid invoice-container" id="invoice" style="margin-top: 20px;">
	...
	{ $counter=1;
		...
		{ 
			...
			<td class="col-4 text-1 border-0" style="background-color: #dcd8cf;color: #000;"><?php echo $counter ?></td>
              <td class="col-4 text-1 border-0" style="background-color: #dcd8cf;color: #000;"><?php echo $row1['productName']; ?></td>
              <td class="col-2 text-center border-0" style="background-color: #dcd8cf;color: #000;">RM <?php echo $row1['p_unitPrice']; ?></td>
        <td class="col-1 text-center border-0" style="background-color: #dcd8cf;color: #000;"><?php echo $row1['p_quantity']; ?></td>
        <td class="col-2 text-right border-0" style="background-color: #2264c4;color: #fff;">RM <?php echo number_format($row1['p_unitPrice'] * $row1['p_quantity'],2); ?></td>
            </tr> <?php $counter++;} } ?>
      ...
      <tfoot class="card-footer">
            ...
            <tr>
              <td colspan="4" class="text-right"><strong>Service Charge (5%) :</strong></td>
  ...
  <a href="orderProHis.php" class="btn btn-light border text-black-50 shadow-none"><i class="fa fa-chevron-left"></i> Back</a>   
  </div>
  </footer> 
